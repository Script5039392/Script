...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			TextColor = Color3.fromRGB(240, 0, 0),
			...
			TabBackground = Color3.fromRGB(230, 0, 0),
			TabStroke = Color3.fromRGB(85, 85, 85),
			TabBackgroundSelected = Color3.fromRGB(0, 210, 210),
			TabTextColor = Color3.fromRGB(240, 240, 240),
			SelectedTabTextColor = Color3.fromRGB(230, 230, 0),
			...
			ToggleEnabled = Color3.fromRGB(0, 235, 0),
			ToggleDisabled = Color3.fromRGB(230, 0, 0),
